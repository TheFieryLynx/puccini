...
- untested: **31**.
- unverifiable: **0**.
- implementation coverage: **216/223 (96.86%)**.
- verified conformance coverage: **166/223 (74.44%)**.
- broad test evidence coverage: **192/223 (86.10%)**.
...
| Properties, attributes and assignments | 20 | 19 | 1 | 0 | 0 | 14 | 1 | 5 | 0 |
