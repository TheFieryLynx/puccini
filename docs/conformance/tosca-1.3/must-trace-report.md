...
- untested: **57**.
- unverifiable: **0**.
- implementation coverage: **184/223 (82.51%)**.
- verified conformance coverage: **134/223 (60.09%)**.
- broad test evidence coverage: **166/223 (74.44%)**.
...
| Properties, attributes and assignments | 20 | 13 | 6 | 1 | 0 | 8 | 1 | 11 | 0 |
